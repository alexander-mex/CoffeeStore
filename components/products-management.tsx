...
export function ProductsManagement() {
  ...
  const getProductName = (product: Product) => {
    return typeof product.name === "string" ? product.name : product.name?.uk || product.name?.en || "Unnamed Product"
  }

  const getProductDescription = (product: Product) => {
    return typeof product.description === "string"
      ? product.description
      : product.description?.uk || product.description?.en || ""
  }
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Badge variant="outline" className="text-xs">
                    {typeof product.category === 'string' ? product.category : product.category?.uk || ''}
                  </Badge>
                </div>
